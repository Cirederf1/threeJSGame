export function addCatFolder(gui, uiData) {
...
export function addRaccoonFolder(gui, uiData) {
...
export function addDogFolder(gui, uiData) {
...
export function addHorseFolder(gui, uiData) {
...
export function addWolfFolder(gui, uiData) {
